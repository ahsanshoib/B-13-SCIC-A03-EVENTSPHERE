...
export default function DashboardCreateEventPage() {
  ...
  const validate = (): boolean => {
    ...
    if (!form.shortDescription.trim()) newErrors.shortDescription = "Required";
    if (!form.fullDescription.trim()) newErrors.fullDescription = "Required";
    ...
    <div className="max-w-2xl">
      <div className="mb-6">
        ...
        <p className="text-muted-foreground text-sm">
          Publish a new event listing from the dashboard
        </p>
      </div>
            ...
            <div className="grid grid-cols-2 gap-4">
              ...
              <div className="space-y-1.5">
                ...
                <Input
                  ...
                  list="cat-suggestions-dash"
                />
                <datalist id="cat-suggestions-dash">
